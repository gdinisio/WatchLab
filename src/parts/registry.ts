...
export const DIAL_PARTS: PartDef[] = [
  ...
  {
    id: 'hour-marker-12',
    name: 'Doubled Marker at 12',
    group: 'dial',
    geometry: () => buildIndex(true),
    material: 'whiteGold',
    position: [0, Y.dialTop, -INDEX_RADIUS],
    explode: { axis: AXIS.up, distance: 13, order: 4 },
    spec: {
      material: '18k white gold',
      function: 'The 12 marker is a doubled baton — the orientation cue that tells you which way up the dial is.',
      finish: 'Polished',
    },
  },
  {
    id: 'hour-marker-12-lume',
    name: 'Marker Luminescence at 12',
    group: 'dial',
    geometry: () => buildIndexLume(true),
    material: 'lume',
    luminous: true,
    position: [0, Y.dialTop, -INDEX_RADIUS],
    explode: { axis: AXIS.up, distance: 13, order: 4 },
    spec: { material: 'Chromalight', function: 'Luminous fill in the doubled 12 marker.' },
  },
  {
    id: 'coronet',
    ...
    material: 'whiteGold',
    position: [0, Y.dialTop + 0.1, -9.3],
    explode: { axis: AXIS.up, distance: 14, order: 4 },
    spec: {
      material: '18k white gold',
      function: 'The five-pointed coronet, applied above the wordmark at 12.',
